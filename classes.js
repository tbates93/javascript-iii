...
class ProgressiveManager {
  ...
  hire (employee) {
    ...
    else if (1 <= this.reports.length && this.reports.length  <= 3) this.title = "Barely Manager"
    else if (4 <= this.reports.length && this.reports.length <= 10) this.title = "Mostly Manager"
    else if (11 <= this.reports.length && this.reports.length <= 50) this.title = "Manager"
    else if (51 <= this.reports.length && this.reports.length <= 100) this.title = "Manager Plus"
...
class Machine {
  ...
  makeWidgets(num){
    ...
    this.wear_and_tear_count += (num*.02)
